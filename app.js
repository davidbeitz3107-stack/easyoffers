...
let cloud={client:null,user:null,workspace:null,ready:false,syncTimer:0,status:'saved',inviteLink:''};
...
Object.assign(window,{
  ...
  printOffer,markOpen,persist,authScreen,submitAuth,signOut,resetScreen,sendReset,passwordUpdateScreen,updatePassword,createInvite,copyInvite
});
bootApp();
