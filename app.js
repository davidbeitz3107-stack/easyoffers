...
let st={page:'home',step:1,o:null,photos:[],settingsTab:'company',catalogSearch:'',catalogCategory:'alle',catalogImport:null,calendarMonth:new Date().getMonth(),calendarYear:new Date().getFullYear(),onboardingStep:1};
